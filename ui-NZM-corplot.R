...
column(width = 9,
       box(title = "correlation plot",
           ...
           solidHeader = TRUE,
           width = NULL,
           plotly::plotlyOutput("NZM_plotly_corplot_out"),
           textOutput("NZM_corvalues_out"), 
           DT::DTOutput("DT_NZM_corplot_df")
           ),
       box(title = "coexpression analysis",
           status = "info",
           solidHeader = TRUE,
           width = NULL,
           DT::DTOutput("DT_NZM_coexp_df")
       ),
       box(title = "correlation plot with selected samples",
           status = "success",
           solidHeader = TRUE,
           width = NULL,
           plotly::plotlyOutput("NZM_plotly_corplot_samples_out"),
           textOutput("NZM_corvalues_samples_out"),
           DT::DTOutput("DT_NZM_corplot_samples_df")
           )
)
)
